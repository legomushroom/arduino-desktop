(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["cascade-signup-client"] = factory();
	else
		root["cascade-signup-client"] = factory();
})(this, function() {
...
var preact_esm = __webpack_require__(4);

// EXTERNAL MODULE: ./node_modules/preact-redux/dist/preact-redux.esm.js
var preact_redux_esm = __webpack_require__(30);

// CONCATENATED MODULE: ./src/decorators/helpers/builder.ts
...
var pushChildren = function (item, stack) {
...
var applyDecorators = function applyDecorators(renderResult, funs) {
    if (funs === void 0) { funs = []; }
...
var builder = function (functions) {
    return function (TargetComponent) {
        var StyledComponent = /** @class */ (function (_super) {
            ...
            StyledComponent.prototype.render = function () {
                // get original render
                var renderResult = _super.prototype.render.call(this);
                // apply functions
...
/* harmony default export */ var helpers_builder = (builder);

// CONCATENATED MODULE: ./src/decorators/helpers/classnames.ts
...
// CONCATENATED MODULE: ./src/decorators/style.ts
...
*/
var style = function classNamesDecorator(styles) {
    var fun = classNames(styles);
    var decorator = helpers_builder([fun]);
...
// EXTERNAL MODULE: ./src/components/dashboard/dashboard.scss
var dashboard = __webpack_require__(61);
var dashboard_default = /*#__PURE__*/__webpack_require__.n(dashboard);

// EXTERNAL MODULE: ./src/components/button/button.scss
var button_button = __webpack_require__(62);
...
var button_Button = /** @class */ (function (_super) {
    ...
    Button.prototype.render = function () {
        var _a = this.props, text = _a.text, className = _a.className, onClick = _a.onClick, onMouseDown = _a.onMouseDown, onMouseUp = _a.onMouseUp, isDisabled = _a.isDisabled;
        var isDisabledClass = isDisabled ? 'isDisabled' : '';
        var onClickCallback = isDisabled ? undefined : onClick;
        return (Object(preact_esm["b" /* h */])("div", { className: "button " + className + " " + isDisabledClass, onClick: onClickCallback, onMouseUp: onMouseUp, onMouseDown: onMouseDown },
            Object(preact_esm["b" /* h */])("span", { className: 'text' }, text)));
    };
    Button = __decorate([
        style(button_default.a)
    ], Button);
    return Button;
}(preact_esm["a" /* Component */]));

;

// CONCATENATED MODULE: ./src/components/dashboard/dashboard.tsx
var dashboard___extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
    return function (d, b) {
...
;
;
var dashboard_Dashboard = /** @class */ (function (_super) {
    dashboard___extends(Dashboard, _super);
    function Dashboard(props) {
        var _this = _super.call(this, props) || this;
        _this.onPressUp = function () {
            _this.socket.emit('press up');
        };
        _this.onPressDown = function () {
            _this.socket.emit('press down');
        };
        _this.onButtonRelease = function () {
            _this.socket.emit('press release');
        };
        _this.state = {
            distance: void 0
        };
    ...
    Dashboard.prototype.componentDidMount = function () {
        ...
        this.socket = lib_default()(protocol + "//" + hostname + ":" + port);
        this.socket.on('connect', function () {
            _this.socket.on('distance', function (distance) {
                _this.setState({ distance: distance });
            });
    ...
    Dashboard.prototype.render = function () {
        return (Object(preact_esm["b" /* h */])("div", { className: "dashboard " + (this.props.className || '') },
            Object(preact_esm["b" /* h */])("div", { className: "distance" },
                this.state.distance,
                Object(preact_esm["b" /* h */])("span", { className: "distance-units" }, "cm")),
            Object(preact_esm["b" /* h */])(button_Button, { text: 'Move up', className: 'button', onMouseDown: this.onPressUp, onMouseUp: this.onButtonRelease }),
            Object(preact_esm["b" /* h */])(button_Button, { text: 'Move down', className: 'button', onMouseDown: this.onPressDown, onMouseUp: this.onButtonRelease })));
    };
    Dashboard = dashboard___decorate([
        style(dashboard_default.a)
    ], Dashboard);
    return Dashboard;
}(preact_esm["a" /* Component */]));
...
var app_App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        return (Object(preact_esm["b" /* h */])(preact_redux_esm["a" /* Provider */], { store: {} },
            Object(preact_esm["b" /* h */])("div", { className: 'app' },
                Object(preact_esm["b" /* h */])(dashboard_Dashboard, null))));
    };
    App = app___decorate([
        style(app_default.a)
    ], App);
...
Object(preact_esm["c" /* render */])(Object(preact_esm["b" /* h */])(app_App, null), document.querySelector('#js-arduino-desktop-app'));
    ...
    var Connect = function (_Component) {
      ...
      Connect.prototype.render = function render() {
        ...
        if (selector.error) {
          ...
          return Object(__WEBPACK_IMPORTED_MODULE_0_preact__["b" /* h */])(WrappedComponent, this.addExtraProps(selector.props));
        }
      };
...
function whenMapDispatchToPropsIsObject(mapDispatchToProps) {
  return mapDispatchToProps && (typeof mapDispatchToProps === 'undefined' ? 'undefined' : _typeof(mapDispatchToProps)) === 'object' ? wrapMapToPropsConstant(function (dispatch) {
    return Object(__WEBPACK_IMPORTED_MODULE_1_redux__["a" /* bindActionCreators */])(mapDispatchToProps, dispatch);
  }) : undefined;
}
...
module.exports = {"app":"app__app___26Cqk"};
...
// removed by extract-text-webpack-plugin
module.exports = {"dashboard":"dashboard__dashboard___lmrb2","distance":"dashboard__distance___3pOc5","distance-units":"dashboard__distance-units___9BH2y","button":"dashboard__button___1I1hl"};
...
// removed by extract-text-webpack-plugin
module.exports = {"button":"button__button___3kagF","isRed":"button__isRed___h2-tG","isGreen":"button__isGreen___2IV5x","isDisabled":"button__isDisabled___2bKOP","text":"button__text___3fm4H"};
